"""
ADCD Noise Robustness Benchmark (Julia & Python Engine Supported)
...
def main():
    ...
    print("=" * 85)
    print(f" ADCD NOISE ROBUSTNESS BENCHMARK (Engine: {args.engine}, Workers: {args.workers})")
    ...
    out_file = os.path.join("run_outputs", f"noise_robustness_{args.engine}.json")
