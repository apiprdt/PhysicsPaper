\begin{table}[H]
\centering
\caption{Structural class match rate: ADCD (Mock Proposer, seed=42) vs.\ PySR on the same 9-scenario residual benchmark. PySR \texttt{fair} is the primary unconstrained baseline.}
\label{tab:baseline}
\begin{tabular}{lcccc}
\toprule
