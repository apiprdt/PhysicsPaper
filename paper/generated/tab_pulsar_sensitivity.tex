...
\midrule
\texttt{P_only} & $P$ & $P^{- \theta_{1}} \cdot \theta_{0}$ & Yes & $3.94 \times 10^{-3}$ \\
\texttt{P_e} & $P, e$ & $\frac{e^{3} \cdot \theta_{0}}{P}$ & Yes & $2.52 \times 10^{-1}$ \\
\texttt{P_e_M} & $P, e, M$ & $P^{- \theta_{1}} \cdot \theta_{0}$ & Yes & $4.81 \times 10^{-1}$ \\
