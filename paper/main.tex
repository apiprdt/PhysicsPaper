...
\texttt{DETECTED\_UNRESOLVED} verdict if $\Delta\mathrm{BIC}_\mathrm{ablation} < 10$; in that case, the
...
ADCD assigns a qualified verdict of \texttt{DETECTED\_UNRESOLVED} rather than reporting an unsupported
discovery.
...
print(result.tier)           # IDENTIFIABLE / DETECTED_UNRESOLVED / WITHHELD
