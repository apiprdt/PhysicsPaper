...
\hline
Unconstrained SR (PySR)~\cite{schmidt2009,cranmer2023} & Free expression tree & None & None (best fit returned) & Open-ended equation discovery \\
...
\textbf{ADCD (ours)}            & Regularized primitive dict. & \textbf{Hard algebraic (exact)} & \textbf{Formal 3-tier validation} & \textbf{Certified physical corrections} \\
\end{tabular}
\end{ruledtabular}
\end{table*}
